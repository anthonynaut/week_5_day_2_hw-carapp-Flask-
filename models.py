...
class Car(db.Model):
    ...
    specs = db.Column(db.String(150), nullable = True)
    mileage = db.Column(db.String(100), nullable = True)
    ...
    def __init__(self,name,description,price, specs,mileage,max_speed,dimensions, weight,cost_of_prod,series, make,user_token, id = ''):
        self.id = self.set_id()
        self.name = name
...
class CarSchema(ma.Schema):
    class Meta:
        fields = ['id', 'name','description', 'price', 'specs', 'mileage', 'max_speed', 'dimensions', 'weight', 'cost_of_prod', 'series', 'make']
